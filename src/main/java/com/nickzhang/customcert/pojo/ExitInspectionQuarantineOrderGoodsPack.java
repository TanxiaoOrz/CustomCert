...
public class ExitInspectionQuarantineOrderGoodsPack {
     ...
     */
    @TableField("Goods_Id")
    @Column(xmlName = "Goods_Id", joinKey = true, joinColumn = "goodsId")
